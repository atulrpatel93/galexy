...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__location__ = __webpack_require__(756);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__ = __webpack_require__(353);
...
var LocationPage = /** @class */ (function () {
    function LocationPage(navCtrl, navParams, geolocation, http, alertCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    LocationPage.prototype.displayGoogleMap = function () {
    ...
    LocationPage.prototype.getMarkersList = function () {
        var _this = this;
        this.http.get('assets/data/markers.json')
            .map(function (res) { return res.json(); })
            .subscribe(function (data) {
            _this.markerList = data.marker;
        }, function (err) { return console.log("error is " + err); });
    };
    LocationPage.prototype.showMarkers = function () {
        var _this = this;
        var sortedArea = this.markerList;
        if (!this.checkedArea || this.checkedArea.length == 0) {
            console.log("if");
            for (var _i = 0; _i < sortedArea.length; _i++) {
                if (_i >= 0)
            ...
            console.log("else");
            this.checkedArea.forEach(function (checkedvalue) {
                sortedArea.forEach(function (area) {
                    if (area['name'] == checkedvalue) {
                        console.log(area);
                        _this.addMarkersToMap(area);
                    }
                });
            });
        }
    };
    LocationPage.prototype.cityZipcpode = function (list) {
        var _this = this;
        console.log(list);
        var sortedArea = this.markerList;
        if (list.length) {
            list.forEach(function (searchedData) {
                sortedArea.forEach(function (area) {
    ...
    LocationPage.prototype.addMarkersToMap = function (marker) {
        ...
        var content = "<h6 text-center>" + marker.name + "</h6> </br><h6 text-center>" + marker.address + "</h6> </br><h6 text-center>" + marker.city + "</h6>";
    ...
    //   });
    // }
    LocationPage.prototype.showCheckbox = function () {
        var _this = this;
        console.log(this.checkedArea);
        var alert = this.alertCtrl.create();
        alert.setTitle('Sort by Category');
        this.markerList.forEach(function (checkboxlist) {
            // if (this.checkedArea) {
        ...
        alert.addButton({
            ...
            handler: function (data) {
                ...
                _this.checkedArea = data;
                _this.displayGoogleMap();
                _this.showMarkers();
                console.log(_this.checkedArea);
            }
        });
        alert.present();
    };
    LocationPage.prototype.filterItems = function () {
        var _this = this;
        var filterResult = this.markerList;
        if (this.myInput != '') {
            var theResult = filterResult.filter(function (item) {
                return item.zipcode.toLowerCase().indexOf(_this.myInput.toLowerCase()) > -1;
            });
    ...
    LocationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-location',template:/*ion-inline-start:"/var/www/html/galexy/Portal-master/src/pages/location/location.html"*/'<ion-header>\n  <portal-header></portal-header>\n</ion-header>\n<ion-footer>\n  <portal-footer></portal-footer>\n</ion-footer>\n\n<ion-content padding>\n  <ion-fab right top style="right:0px;top:0px;background-color: rgba(0,0,0,0.5);">\n    <button style="background-color: transparent;font-size: 1.2rem;padding:10px;padding-bottom: 5px;">\n      <div style="color:white;">\n        <i class="fa fa-sign-in" aria-hidden="true" style="color: rgb(239, 167, 32);"></i><br>\n        Login\n      </div>\n    </button>\n    <button style="background-color: transparent;font-size: 1.2rem;padding:10px;padding-bottom: 5px;">\n      <div style="color:white;">\n        <i class="fa fa-user" aria-hidden="true" style="color: rgb(239, 167, 32);"></i><br>\n        Register\n      </div>\n    </button>\n  </ion-fab>\n\n  <ion-row text-center>\n    <ion-col>\n      <button ion-button round (click)="showCheckbox()">Business Type</button>\n    </ion-col>\n    <ion-col>\n      <ion-searchbar [(ngModel)]="myInput" [showCancelButton]="shouldShowCancel" (ionInput)="filterItems($event)"\n        (ionCancel)="onCancel($event)">\n      </ion-searchbar>\n    </ion-col>\n    <!-- <ion-col>\n      <ion-searchbar [(ngModel)]="myInput">\n      </ion-searchbar>\n    </ion-col>\n    <ion-col>\n      <button ion-button round (click)="submit()">Submit</button>\n    </ion-col> -->\n  </ion-row>\n  <div #map id=\'map\'></div>\n</ion-content>\n'/*ion-inline-end:"/var/www/html/galexy/Portal-master/src/pages/location/location.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["w" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_geolocation__["a" /* Geolocation */], __WEBPACK_IMPORTED_MODULE_3__angular_http__["a" /* Http */],

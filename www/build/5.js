...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserportalPageModule", function() { return UserportalPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__userportal__ = __webpack_require__(773);
...
var UserportalPageModule = /** @class */ (function () {
    function UserportalPageModule() {
    }
    UserportalPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__userportal__["a" /* UserportalPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__userportal__["a" /* UserportalPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], UserportalPageModule);
    return UserportalPageModule;
}());

//# sourceMappingURL=userportal.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UserportalPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_data_data__ = __webpack_require__(351);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
 ...
 */
var UserportalPage = /** @class */ (function () {
    // specificPortalData:any = [];
    function UserportalPage(navCtrl, navParams, loadingCtrl, dataProvider, menuCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        ...
        this.portalsData = [];
        this.toDisplayPortalData = [];
        this.selectedPortal = '';
    }
    UserportalPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.dataProvider.showLoading();
        var userDetails = JSON.parse(localStorage.getItem("userCredentials"));
        var username = userDetails.username;
        this.dataProvider.getUserPortalsData({ "username": username }).then(function (portalsDetail) {
            _this.dataProvider.hideLoading();
            _this.portalsData = portalsDetail.allPortalsData;
            //this.toDisplayPortalData = portalsDetail.displayPortal;
            // console.log('1st Data'+this.toDisplayPortalData);
            _this.selectedPortal = portalsDetail.allPortalsData[0].id;
        }).catch(function (err) {
            _this.dataProvider.hideLoading();
            _this.dataProvider.errorALertMessage(err);
        });
    };
    UserportalPage.prototype.changeUserPortal = function () {
        var _this = this;
        // console.log(this.selectedPortal);
        this.dataProvider.showLoading();
        this.dataProvider.getSpecificUserPortalData({ "portalId": this.selectedPortal }).then(function (specificPortalDetail) {
            _this.dataProvider.hideLoading();
            // console.log('2nd Data'+specificPortalDetail);
            _this.toDisplayPortalData = specificPortalDetail;
        }).catch(function (err) {
            _this.dataProvider.hideLoading();
            _this.dataProvider.errorALertMessage(err);
        });
    };
    UserportalPage.prototype.openPortalProfile = function (portalId) {
        console.log(portalId);
        this.navCtrl.push("PortaldetailPage", { portalId: portalId }, { animate: false });
    };
    UserportalPage.prototype.openPortalMenu = function (portalId) {
        this.navCtrl.push("PortalprofilemenuPage", { portalId: portalId }, { animate: false });
    };
    // right menu2 disable
    UserportalPage.prototype.ionViewDidEnter = function () {
        this.menuCtrl.enable(false, 'menu2');
    };
    UserportalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-userportal',template:/*ion-inline-start:"/var/www/html/galexy/Portal-master/src/pages/userportal/userportal.html"*/'<ion-header>\n  <portal-header></portal-header>\n</ion-header>\n<ion-footer>\n  <portal-footer></portal-footer>\n</ion-footer>\n\n<ion-content class="pageBackground" padding>\n  <ion-fab right top style="right:0px;top:0px;background-color: rgba(0,0,0,0.5);">\n    <button style="background-color: transparent;font-size: 1.2rem;padding:10px;padding-bottom: 5px;">\n      <div style="color:white;">\n        <i class="fa fa-sign-in" aria-hidden="true" style="color: rgb(239, 167, 32);"></i><br>\n        Login\n      </div>\n    </button>\n    <button style="background-color: transparent;font-size: 1.2rem;padding:10px;padding-bottom: 5px;">\n      <div style="color:white;">\n        <i class="fa fa-user" aria-hidden="true" style="color: rgb(239, 167, 32);"></i><br>\n        Register\n      </div>\n    </button>\n  </ion-fab>\n\n  <ion-row class="row-border-bottom">\n    <ion-col col-4>\n      <ion-label color="light">Portals</ion-label>\n    </ion-col>\n    <ion-col col-8>\n      <ion-select [(ngModel)]="selectedPortal" (ionChange)="changeUserPortal()" class="portal-select">\n        <ion-option *ngFor="let portalList of portalsData" value="{{portalList.id}}">{{portalList.name}}</ion-option>\n      </ion-select>\n    </ion-col>\n  </ion-row>\n\n  <div class="selected-portal-logo margin-top-20" col-12>\n    <div class="selected-portal-logo-img">\n      <img *ngIf="toDisplayPortalData.portal_logo==\'\'" src="https://www.420portal.com/img/uploaded/420portalspiral.png" />\n\n     <img *ngIf="toDisplayPortalData.portal_logo!=\'\'" src="https://www.420portal.com/img/{{toDisplayPortalData.portal_logo}}" />\n    </div>\n\n    <p>{{toDisplayPortalData.name}}</p>\n  </div>\n\n  <ion-row class="margin-top-20">\n      <ion-col col-4 class="portal-icon-holder"><ion-icon name="eye" color="420-head-text" class="portal-icon" (click)="openPortalProfile(toDisplayPortalData.id)"></ion-icon></ion-col>\n      <ion-col col-4 class="portal-icon-holder"><ion-icon name="settings" color="420-head-text" class="portal-icon"></ion-icon></ion-col>\n      <ion-col col-4 class="portal-icon-holder"><ion-icon name="clipboard" color="420-head-text" class="portal-icon" (click)="openPortalMenu(toDisplayPortalData.id)"></ion-icon></ion-col>\n  </ion-row>\n\n  <ion-row>\n      <ion-col col-4 class="portal-icon-holder"><ion-icon name="card" color="420-head-text" class="portal-icon"></ion-icon></ion-col>\n      <ion-col col-4 class="portal-icon-holder"><ion-icon name="images" color="420-head-text" class="portal-icon"></ion-icon></ion-col>\n      <ion-col col-4 class="portal-icon-holder"><ion-icon name="chatboxes" color="420-head-text" class="portal-icon"></ion-icon></ion-col>\n  </ion-row>\n</ion-content>\n'/*ion-inline-end:"/var/www/html/galexy/Portal-master/src/pages/userportal/userportal.html"*/,
        }),

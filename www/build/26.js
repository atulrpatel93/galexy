...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__coupons__ = __webpack_require__(745);
...
var CouponsPageModule = /** @class */ (function () {
    ...
    CouponsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__coupons__["a" /* CouponsPage */]),
...
var CouponsPage = /** @class */ (function () {
    function CouponsPage(navCtrl, navParams, loadingCtrl, menuCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    CouponsPage.prototype.couponDetail = function () {
        this.navCtrl.push("CouponDetailPage", {}, { animate: false });
    };
    // right menu2 disable
    CouponsPage.prototype.ionViewDidEnter = function () {
        this.menuCtrl.enable(false, 'menu2');
    };
    CouponsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-coupons',template:/*ion-inline-start:"/var/www/html/galexy/Portal-master/src/pages/coupons/coupons.html"*/'\n<ion-header>\n  <portal-header></portal-header>\n</ion-header>\n<ion-footer>\n  <portal-footer></portal-footer>\n</ion-footer>\n\n<ion-content class="menu-items">\n  <ion-fab right top style="right:0px;top:0px;background-color: rgba(0,0,0,0.5);">\n    <button style="background-color: transparent;font-size: 1.2rem;padding:10px;padding-bottom: 5px;">\n      <div style="color:white;">\n        <i class="fa fa-sign-in" aria-hidden="true" style="color: rgb(239, 167, 32);"></i><br>\n        Login\n      </div>\n    </button>\n    <button style="background-color: transparent;font-size: 1.2rem;padding:10px;padding-bottom: 5px;">\n      <div style="color:white;">\n        <i class="fa fa-user" aria-hidden="true" style="color: rgb(239, 167, 32);"></i><br>\n        Register\n      </div>\n    </button>\n  </ion-fab>\n\n  <ion-card no-padding no-margin style="width: 100%">\n    <ion-item>\n\n    </ion-item>\n    <img src="../../assets/imgs/plants.jpg" (click)="couponDetail()">\n    <ion-card-content>\n      <ion-item>\n        <h2 color="light">Marijanuna Coupon</h2>\n        <p class="date" item-end>Expiry Date</p>\n      </ion-item>\n    </ion-card-content>\n  </ion-card>\n\n  <ion-card no-padding no-margin style="width: 100%">\n    <ion-item>\n    </ion-item>\n    <img src="../../assets/imgs/plants2.jpg" (click)="couponDetail()">\n    <ion-card-content>\n      <ion-item>\n        <h2 color="light">Coupon name</h2>\n        <p class="date" item-end>Expiry Date</p>\n      </ion-item>\n    </ion-card-content>\n  </ion-card>\n  <ion-card no-padding no-margin style="width: 100%">\n    <ion-item>\n    </ion-item>\n    <img src="../../assets/imgs/water3.jpg"  (click)="couponDetail()">\n    <ion-card-content>\n      <ion-item>\n        <h2 color="light">Marijanuna Coupon</h2>\n        <p class="date" item-end>Expiry Date</p>\n      </ion-item>\n    </ion-card-content>\n  </ion-card>\n</ion-content>\n'/*ion-inline-end:"/var/www/html/galexy/Portal-master/src/pages/coupons/coupons.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["w" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* MenuController */]])
    ], CouponsPage);
    return CouponsPage;
}());

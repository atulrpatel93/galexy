...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChatwindowPageModule", function() { return ChatwindowPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chatwindow__ = __webpack_require__(737);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_emoji_picker_emoji_picker_module__ = __webpack_require__(738);
...
var ChatwindowPageModule = /** @class */ (function () {
    function ChatwindowPageModule() {
    }
    ChatwindowPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__chatwindow__["a" /* ChatwindowPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3__components_emoji_picker_emoji_picker_module__["a" /* EmojiPickerComponentModule */],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__chatwindow__["a" /* ChatwindowPage */]),
                __WEBPACK_IMPORTED_MODULE_4__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], ChatwindowPageModule);
    return ChatwindowPageModule;
}());

//# sourceMappingURL=chatwindow.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ChatwindowPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var ChatwindowPage = /** @class */ (function () {
    function ChatwindowPage(navCtrl, navParams, menuCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    ...
    // right menu2 disable
    ChatwindowPage.prototype.ionViewDidEnter = function () {
    ...
    //   this.scrollToBottom();
    // }
    ChatwindowPage.prototype.focus = function () {
        if (this.messageInput && this.messageInput.nativeElement) {
            this.messageInput.nativeElement.focus();
        }
    };
    ChatwindowPage.prototype.setTextareaScroll = function () {
    ...
    ChatwindowPage.prototype.onFocus = function () {
        this.showEmojiPicker = false;
        this.content.resize();
        this.scrollToBottom();
    };
    ChatwindowPage.prototype.back = function () {
        this.navCtrl.push('ChatPage', {}, { animate: false });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('chat_input'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */])
    ], ChatwindowPage.prototype, "messageInput", void 0);
    __decorate([
    ...
    ChatwindowPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-chatwindow',template:/*ion-inline-start:"/var/www/html/galexy/Portal-master/src/pages/chatwindow/chatwindow.html"*/'<ion-header>\n  <portal-header></portal-header>\n</ion-header>\n<ion-footer>\n  <portal-footer></portal-footer>\n</ion-footer>\n<ion-content class="menu-items">\n  <div class="title-white" ion-fixed>\n    <span>\n      <ion-icon name="arrow-back" (click)="back()" class="back_icon"></ion-icon>\n    </span>\n    <p>Goshawk</p>\n  </div>\n  <div class="user_bar" ion-fixed>\n    <img src="../../assets/imgs/off.png" alt="" class="offimg">\n    <p>goshawk</p>\n    <span><i class="fa fa-trash"></i></span>\n    <span><i class="fa fa-times"></i></span>\n  </div>\n  <div class="chat-body">\n    <div class="chat-message-container">\n      <ion-avatar item-start class="left_avatar">\n        <img src="../../assets/imgs/main_avatar.png">\n      </ion-avatar>\n      <span class="chat-div textLeft">\n        <span class="chat-message-time">8-3-2019 10:31 pm</span>\n        <span class="chat-message">Hi there.</span>\n      </span>\n    </div>\n\n    <div class="chat-message-container">\n      <ion-avatar item-end class="right_avatar">\n        <img src="../../assets/imgs/main_avatar.png">\n      </ion-avatar>\n      <span class="chat-div textRight">\n        <span class="chat-message-time">7-3-2019 10:31 pm</span>\n        <span class="chat-message">Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi there. Hi\n          there. Hi there. Hi there. Hi there.</span>\n      </span>\n    </div>\n\n    <div class="chat-message-container">\n      <span class="chat-div textLeft">\n        <span class="chat-message-time">8-3-2019 10:31 pm</span>\n        <span class="chat-message">Hi there.</span>\n      </span>\n    </div>\n\n    <div class="chat-message-container">\n      <span class="chat-div textLeft">\n        <span class="chat-message-time">8-3-2019 10:31 pm</span>\n        <span class="chat-message">Hi there.</span>\n      </span>\n    </div>\n  </div>\n  <div class="chat_box" ion-fixed>\n    <div class="input-wrap">\n      <textarea #chat_input placeholder="Write a message..." [(ngModel)]="editorMsg" (focusin)="onFocus()" rows="1">\n        </textarea>\n      <button ion-button clear icon-only item-right (click)="sendMsg()" style="margin-bottom: 5px;">\n        <ion-icon name="paper-plane" ios="ios-send" md="md-send"></ion-icon>\n      </button>\n    </div>\n  </div>\n</ion-content>'/*ion-inline-end:"/var/www/html/galexy/Portal-master/src/pages/chatwindow/chatwindow.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__emoji_picker__ = __webpack_require__(739);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EmojiPickerComponent = /** @class */ (function () {
    ...
    EmojiPickerComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            providers: [EMOJI_PICKER_VALUE_ACCESSOR],template:/*ion-inline-start:"/var/www/html/galexy/Portal-master/src/components/emoji-picker/emoji-picker.html"*/'<!-- Generated template for the EmojiPickerComponent component -->\n<div class="emoji-picker">\n  <div class="emoji-items">\n    <ion-slides pager>\n\n      <ion-slide *ngFor="let items of emojiArr">\n        <span class="emoji-item"\n              (click)="setValue(item)"\n              *ngFor="let item of items">\n          {{item}}\n        </span>\n      </ion-slide>\n\n    </ion-slides>\n  </div>\n</div>\n'/*ion-inline-end:"/var/www/html/galexy/Portal-master/src/components/emoji-picker/emoji-picker.html"*/
        }),

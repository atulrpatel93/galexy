...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StraindetailPageModule", function() { return StraindetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__straindetail__ = __webpack_require__(770);
...
var StraindetailPageModule = /** @class */ (function () {
    function StraindetailPageModule() {
    }
    StraindetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__straindetail__["a" /* StraindetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__straindetail__["a" /* StraindetailPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], StraindetailPageModule);
    return StraindetailPageModule;
}());

//# sourceMappingURL=straindetail.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StraindetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_data_data__ = __webpack_require__(351);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
 ...
 */
var StraindetailPage = /** @class */ (function () {
    function StraindetailPage(navCtrl, navParams, loadingCtrl, dataProvider) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.loadingCtrl = loadingCtrl;
        this.dataProvider = dataProvider;
        this.categoryDetails = [];
        this.categoryStrains = [];
        this.toShowStrains = [];
        this.strainCategorySlug = '';
    }
    StraindetailPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        console.log('ionViewDidLoad StraindetailPage');
        this.strainCategorySlug = this.navParams.get("slug");
        this.dataProvider.showLoading();
        this.dataProvider.getStrainCategoryData({ "categorySlug": this.strainCategorySlug }).then(function (strainCategoryDetail) {
            _this.dataProvider.hideLoading();
            _this.categoryDetails = strainCategoryDetail.categoryData;
            _this.categoryStrains = strainCategoryDetail.categoryStrains;
            _this.toShowStrains = _this.categoryStrains;
    ...
    StraindetailPage.prototype.openSpecificStrainDetail = function (strainId, slug) {
        this.navCtrl.push("StrainsubdetailPage", { strainKey: strainId, strainName: slug }, { animate: false });
    };
    StraindetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-straindetail',template:/*ion-inline-start:"/var/www/html/galexy/Portal-master/src/pages/straindetail/straindetail.html"*/'<ion-header>\n  <portal-header></portal-header>\n</ion-header>\n<ion-footer>\n  <portal-footer></portal-footer>\n</ion-footer>\n\n<ion-content class="menu-items">\n  <ion-fab top style="right:0px;top:0px;background-color: rgba(0,0,0,0.5);">\n    <button style="background-color: transparent;font-size: 1.2rem;padding:10px;padding-bottom: 5px;">\n      <div style="color:white;">\n        <i class="fa fa-user" aria-hidden="true" style="color: rgb(239, 167, 32);"></i><br>\n        Register\n      </div>\n    </button>\n    <button style="background-color: transparent;font-size: 1.2rem;padding:10px;padding-bottom: 5px;">\n      <div style="color:white;">\n        <i class="fa fa-sign-in" aria-hidden="true" style="color: rgb(239, 167, 32);"></i><br>\n        Login\n      </div>\n    </button>\n  </ion-fab>\n  <strain-searchbar [strains]="categoryStrains"></strain-searchbar>\n  <div class="data-container">\n    <ion-card transparent>\n      <ion-card-header class="subtitle" text-center>\n        {{categoryDetails.name}}\n      </ion-card-header>\n      <ion-card-content color="dark" class="description">\n        <div [innerHtml]="categoryDetails.description" class="description-container"></div>\n      </ion-card-content>\n    </ion-card>\n    <ion-label class="subtitle" text-center>{{categoryDetails.name}} Marijuana Strains</ion-label>\n    <ion-grid>\n      <ion-row>\n        <ion-col class="sub-item" *ngFor="let strainImages of toShowStrains" col-6 (click)="openSpecificStrainDetail(strainImages.id, strainCategorySlug)">\n          <div class="sub-item-container">\n            <img [src]="strainImages.strain_image" class="thumbimage"/>\n            <div class="strain_title">{{strainImages.name}}</div>\n          </div>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/var/www/html/galexy/Portal-master/src/pages/straindetail/straindetail.html"*/,
        }),
...
//# sourceMappingURL=straindetail.js.map

...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CouponDetailPageModule", function() { return CouponDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__coupon_detail__ = __webpack_require__(744);
...
var CouponDetailPageModule = /** @class */ (function () {
    function CouponDetailPageModule() {
    }
    CouponDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__coupon_detail__["a" /* CouponDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__coupon_detail__["a" /* CouponDetailPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], CouponDetailPageModule);
    return CouponDetailPageModule;
}());

//# sourceMappingURL=coupon-detail.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CouponDetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(21);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var CouponDetailPage = /** @class */ (function () {
    function CouponDetailPage(navCtrl, navParams, menuCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.menuCtrl = menuCtrl;
    }
    CouponDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad CouponDetailPage');
    };
    // right menu2 disable
    CouponDetailPage.prototype.ionViewDidEnter = function () {
        this.menuCtrl.enable(false, 'menu2');
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_8" /* ViewChild */])('map'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* ElementRef */])
    ], CouponDetailPage.prototype, "mapContainer", void 0);
    CouponDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-coupon-detail',template:/*ion-inline-start:"/var/www/html/galexy/Portal-master/src/pages/coupon-detail/coupon-detail.html"*/'<ion-header>\n  <portal-header></portal-header>\n</ion-header>\n<ion-footer>\n  <portal-footer></portal-footer>\n</ion-footer>\n\n\n<ion-content padding class="menu-items">\n  <ion-fab right top style="right:0px;top:0px;background-color: rgba(0,0,0,0.5);">\n    <button style="background-color: transparent;font-size: 1.2rem;padding:10px;padding-bottom: 5px;">\n      <div style="color:white;">\n        <i class="fa fa-sign-in" aria-hidden="true" style="color: rgb(239, 167, 32);"></i><br>\n        Login\n      </div>\n    </button>\n    <button style="background-color: transparent;font-size: 1.2rem;padding:10px;padding-bottom: 5px;">\n      <div style="color:white;">\n        <i class="fa fa-user" aria-hidden="true" style="color: rgb(239, 167, 32);"></i><br>\n        Register\n      </div>\n    </button>\n  </ion-fab>\n\n  <div class="coupon-detail">\n    <ion-row>\n      <div #map id=\'map\'></div>\n    </ion-row>\n    <ion-row>\n      <ion-col col-4 align-self-center text-center>\n        <img src="../../assets/imgs/avatar.png">\n      </ion-col>\n      <ion-col col-3 align-self-center text-center>\n        <ion-label class="name">1</ion-label>\n        <p class="phoneno">Post</p>\n      </ion-col>\n      <ion-col col-3 align-self-center text-center>\n        <ion-label class="name">0</ion-label>\n        <p class="phoneno">Follower</p>\n      </ion-col>\n      <ion-col col-2>\n\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-label class="name">Urban Bud</ion-label>\n    </ion-row>\n    <ion-row>\n      <ion-col col-2 align-self-center text-center>\n        <img src="../../assets/imgs/dispensary.png">\n      </ion-col>\n      <ion-col col-10 self-align-center>\n        <ion-label class="dispancary-name">(StoreFront)</ion-label>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-label class="address">112 S 24th St, Tacoma</ion-label>\n    </ion-row>\n    <ion-row>\n      <ion-label class="phoneno">253-327-1572</ion-label>\n    </ion-row>\n    <ion-row text-center justify-content-center>\n      <ion-col col-3 align-self-center text-center>\n        <ion-icon name="heart" class="like-comment"></ion-icon>\n        <ion-label>10</ion-label>\n      </ion-col>\n      <ion-col col-3>\n        <ion-icon name="paper-plane" class="like-comment"></ion-icon>\n        <ion-label>10</ion-label>\n      </ion-col>\n      <ion-col col-3>\n        <ion-icon name="document" class="like-comment"></ion-icon>\n        <ion-label>10</ion-label>\n      </ion-col>\n      <ion-col col-3>\n        <ion-icon name="home" class="like-comment"></ion-icon>\n        <ion-label>10</ion-label>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col col-4>\n        <img src="../../assets/imgs/avatar.png">\n      </ion-col>\n      <ion-col col-4>\n        <label></label>\n      </ion-col>\n      <ion-col col-4>\n      </ion-col>\n    </ion-row>\n\n  </div>\n</ion-content>\n'/*ion-inline-end:"/var/www/html/galexy/Portal-master/src/pages/coupon-detail/coupon-detail.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["v" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["w" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* MenuController */]])
    ], CouponDetailPage);
